        ...
        <DashboardLayout>
            <div className={containerClass}>
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">TikTok Page</h1>
                        <p className="text-gray-600 dark:text-gray-400 mt-1">Edit TikTok Page Sections</p>
                    </div>
