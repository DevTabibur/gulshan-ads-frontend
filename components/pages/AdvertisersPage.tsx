...
import { getAllAdvertisersPageSections } from "@/app/api/advertiserspage/advertisersPage.Api"
                ...
                <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 dark:from-slate-900 dark:via-slate-800 dark:to-emerald-900">
                            ...
                            <div className="grid lg:grid-cols-2 gap-12 items-center">
                                <motion.div variants={itemVariants} className="space-y-8">
                                    ...
                                    <motion.h1 className="text-4xl lg:text-6xl font-bold leading-tight" variants={itemVariants}>
                                        {advertisersPageData?.scaleYourBusiness?.title ? (
                                    ...
                                    >
                                        {advertisersPageData?.scaleYourBusiness?.description}
                            ...
                            <motion.div className="text-center mb-16" variants={itemVariants}>
                                <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-6">
                                    <span className="bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent">
                                        {advertisersPageData?.whyAdvertisers?.title}
                                    </span>
                                </h2>
                                <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
                                    {advertisersPageData?.whyAdvertisers?.description}
                                </p>
                            </motion.div>

                            <div className="grid lg:grid-cols-2 gap-8">
                                {Array.isArray(advertisersPageData?.whyAdvertisers?.cards) && advertisersPageData.whyAdvertisers.cards.length > 0 ? (
                                    advertisersPageData.whyAdvertisers.cards.map((benefit: any, index: number) => {
                                        const benefitIcons = [Target, Zap, Award, BarChart3];
                                        let IconComponent = benefitIcons[index % benefitIcons.length];
                                        
                                        const title = benefit?.title || "";
                                        const description = benefit?.description || "";

                                        // If both title and description are empty, skip rendering this card
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="relative bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 group-hover:shadow-xl transition-all duration-300">
                                                    <div
                                                        className={`inline-flex items-center justify-center w-14 h-14 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-xl mb-6`}
                                                    >
                                    ...
                                    <div className="col-span-2 text-center text-slate-500 dark:text-slate-400 py-12">
                    ...
                    >
                        <div className="container mx-auto px-4">
                            <motion.div className="text-center mb-16" variants={itemVariants}>
                                <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-6">
                                    {advertisersPageData?.chooseYourPlan?.title ? (
                                        <span className="bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent">
                                            {advertisersPageData.chooseYourPlan.title}
                                        </span>
                                    ) : (
                                ...
                                <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
                                    {advertisersPageData?.chooseYourPlan?.description}
                                </p>
                            </motion.div>
                            ...
                            <div className="grid lg:grid-cols-3 gap-8">
                                {(() => {
                                    ...
                                    // Fallback icon if more than 3 cards
                                    ...
                                    return (advertisersPageData?.chooseYourPlan?.cards || []).map((card: any, index: number) => {
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <ul className="space-y-3 mb-8">
                                                        {(card.points || []).flatMap((point: string) =>
                                                            point
                                                                .split(',')
                                                                .map(str => str.trim())
                                                                .filter(str => str.length > 0)
                                                        ).map((singlePoint: string, idx: number) => (
                                                            <li
                                                                key={idx}
                    ...
                    >
                        <div className="container mx-auto px-4">
                            <motion.div className="text-center mb-16" variants={itemVariants}>
                                <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-6">
                                    {advertisersPageData?.howWeGetYouStarted?.title ? (
                                        <span className="bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent">
                                            {advertisersPageData?.howWeGetYouStarted?.title}
                                        </span>
                                    ) : null}
                                ...
                                <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
                                    {advertisersPageData?.howWeGetYouStarted?.description}
                                </p>
                            </motion.div>

                            <div className="grid lg:grid-cols-4 gap-8">
                                {(() => {
                                    const stepIcons = [MessageSquare, Lightbulb, Rocket, TrendingUp];
                                    return advertisersPageData?.howWeGetYouStarted?.cards?.map((step: any, index: number) => {
                                        const Icon = stepIcons[index] || Star;
                                        return (
                                            <motion.div
                                                key={index}
                                                className="group relative"
                                            ...
                                            >
                                                ...
                                                {index < (advertisersPageData?.howWeGetYouStarted?.cards?.length ?? 0) - 1 && (
                        ...
                        <div className="container mx-auto px-4 relative z-10">
                            <motion.div className="text-center max-w-4xl mx-auto" variants={itemVariants}>
                                <h2 className="text-4xl lg:text-6xl font-bold text-white mb-6">
                                        {advertisersPageData?.readyToScaleYourBusiness?.title}
                                ...
                                <p className="text-xl text-white/90 mb-8 leading-relaxed">
                                    ...
                                    {advertisersPageData?.readyToScaleYourBusiness?.description}
                                </p>
